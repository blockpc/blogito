...
<div class="text-green-800 px-6 py-4 border-0 rounded relative mb-4 bg-green-400" id="alert-success">
...
<div class="text-red-800 px-6 py-4 border-0 rounded relative mb-4 bg-red-400" id="alert-error">
    <div class="max-w-7xl mx-auto">
        <span class="text-xl inline-block mr-5 align-middle">
            <i class="fas fa-bell"></i>
        </span>
...
<div class="text-blue-800 px-6 py-4 border-0 rounded relative mb-4 bg-blue-400" id="alert-message">
    <div class="max-w-7xl mx-auto">
        <span class="text-xl inline-block mr-5 align-middle">
            <i class="fas fa-bell"></i>
        </span>
...
<div class="text-yellow-800 px-6 py-4 border-0 rounded relative mb-4 bg-yellow-400" id="alert-warning">
    <div class="max-w-7xl mx-auto">
        <span class="text-xl inline-block mr-5 align-middle">
            <i class="fas fa-bell"></i>
        </span>
